...
st.markdown("<div class='head'> Meet Strataz </div>", unsafe_allow_html=True)
        
col1, col2 = st.columns([2, 1])

col1.markdown("""<p class='about'> Strataz is an analytics consulting firm that is focused on providing
               organizations with advanced analytic tools that allows them scale. We boost of competent 
               teams which are able to deliver cost effective and efficient tools in handling different business problems
               ranging from marketing to decision making to human mangement etc.</p> """, unsafe_allow_html=True)
...
team1.image('resources/imgs/img.jpg', use_column_width=True)
...
team2.image('resources/imgs/img.jpg', use_column_width=True)
...
team3.image('resources/imgs/img.jpg', use_column_width=True)
...
team4.image('resources/imgs/img.jpg', use_column_width=True)
team4.markdown("<p class='name'> Abubakar Abdulkadir </p>", unsafe_allow_html=True)
team4.markdown("<p class='role'> Team Lead </p>", unsafe_allow_html=True)